...
with open(r"Deployed/toxic_vect.pkl", "rb") as f:
    tox = pickle.load(f)

with open(r"Deployed/severe_toxic_vect.pkl", "rb") as f:
    sev = pickle.load(f)

with open(r"Deployed/obscene_vect.pkl", "rb") as f:
    obs = pickle.load(f)

with open(r"Deployed/insult_vect.pkl", "rb") as f:
    ins = pickle.load(f)

with open(r"Deployed/threat_vect.pkl", "rb") as f:
    thr = pickle.load(f)

with open(r"Deployed/identity_hate_vect.pkl", "rb") as f:
    ide = pickle.load(f)

# Load the pickled RDF models
with open(r"Deployed/toxic_model.pkl", "rb") as f:
    tox_model = pickle.load(f)

with open(r"Deployed/severe_toxic_model.pkl", "rb") as f:
    sev_model = pickle.load(f)

with open(r"Deployed/obscene_model.pkl", "rb") as f:
    obs_model  = pickle.load(f)

with open(r"Deployed/insult_model.pkl", "rb") as f:
    ins_model  = pickle.load(f)

with open(r"Deployed/threat_model.pkl", "rb") as f:
    thr_model  = pickle.load(f)

with open(r"Deployed/identity_hate_model.pkl", "rb") as f:
...
st.image("f1score.png", caption="Fig 1. F1 Score Comparision", use_column_width=True)
st.image("percentagecomm.png", caption="Fig 2. Percentage of comments used as an insult/abuse", use_column_width=True)
